...
from ocr_service.models.paddle_ocr import PaddleInferOCR2
...
def get_ocr_processor(file_connector: BaseFileConnector) -> OCRWorker:
    ...
    if paddleocr.__version__ == "3.0.1":
        ...
        ocr_model = PaddleInferOCR2(path_model=ocr_settings.PADDLE_OCR_BASE_DIR)
